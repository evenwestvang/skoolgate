...
Light weight site for viewing Norwegian national school benchmarks, "Nasjonale Prøver".
...
Dependencies:
  ...
  * Bundler
  * Ruby 1.9.2
  * Thor - for importing data

Repo ships with all the production data dumped to a MongoDB backup. From root just:

@@@@
mongorestore -d skoolgate_development data/nuskool_development
thin start
@@@@
...
NEXT:
  ...
  * Add school results to county and municipal views using http://tablesorter.com/docs/#Demo. Pretty up.
